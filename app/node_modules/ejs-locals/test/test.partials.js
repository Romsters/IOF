...
app.get('/non-existent-partials',function(req,res,next){
  res.render('non-existent-partials.ejs');
})
...
describe('app',function(){
  ...
  describe('GET /non-existent-partials',function(){
    it('should send 500 and error saying a partials was not found',function(done){
      request(app)
        .get('/non-existent-partials')
        .end(function(res){
          res.should.have.status(500);
          res.body.should.include('Could not find partials non-existent');
          done();
        })
    })
  })
